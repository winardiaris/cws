...
<h4>Assessment Remaks</h4>
	<table    class="table table-bordered">
		<tr>
			<td width="16%"><label>File Number:</label></td>
			<td width="16%"><?php if($edit==1){echo $data['file_no'];}?></td>
			
			<td width="16%"><label>Date of Assessment:</label></td>
			<td width="16%"><?php if($edit==1){echo $data['doa'];}?></td>
			
			<td width="16%"><label>Interviewer:</label></td>
...
<h4>A. GENERAL</h4>
	...
	<table    class="table table-bordered">
		<tr>
			<td width="300px"><label>Security and Safety Measures:</label></td>
			<td  colspan="3">
				...
				<br><label><input disabled type="checkbox" id="sec_3" value="1" <?php if($edit==1){if($sec[2]==1){echo "checked";}} ?>> Secure doors & windows</label>
				...
				<br><label><input disabled type="checkbox" id="sec_5" value="1" <?php if($edit==1){if($sec[4]==1){echo "checked";}} ?>> Fire Extinguisher</label>
			</td>
		</tr>
		<tr>
			...
			<td  colspan="3">
				...
				<br><label><input disabled type="checkbox" id="neig_3" value="1" <?php if($edit==1){if($neigh[2]==1){echo "checked";}} ?>> Slum area</label>
				<label><input disabled type="checkbox" id="neig_4" value="1" <?php if($edit==1){if($neigh[3]==1){echo "checked";}} ?>> Trading area</label>
				<br><label><input disabled type="checkbox" id="neig_5" value="1" <?php if($edit==1){if($neigh[4]==1){echo "checked";}} ?>> Others</label>
			</td>
		</tr>
		<tr>
			<td width="25%"><label>Police station:</label></td>
			<td width="25%"><?php if($edit==1){echo $phnn[0];}?></td>
			
			<td width="25%"><label>Health facilities:</label></td>
